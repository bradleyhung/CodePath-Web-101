...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-fuchsia-100 via-pink-100 to-purple-100 dark:from-fuchsia-950 dark:via-purple-950 dark:to-indigo-950 animate-gradient">
      <header className="sticky top-0 z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md shadow-md">
        <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
          <Link href="/" className="flex items-center space-x-2">
            <Image
              src="/study.png"
              alt="GirlsWhoCode BC Logo"
              width={40}
              height={40}
            />
      ...
      <footer className="bg-purple-900 dark:bg-gray-950 py-8 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p>
            &copy; {new Date().getFullYear()} GirlsWhoCode Brooklyn College. All
            rights reserved.
          </p>
        </div>
      </footer>
